                            ...
                            <li class="active">
                              ...
                              <li>
                                  <a href="{{ route('customer.cp') }}" class="waves-effect waves-dark">
                                      ...
                                      <span class="pcoded-mtext" data-i18n="nav.form-components.main">Pesan Catering</span>
                                      <span class="pcoded-mcaret"></span>
                                  </a>
                              </li>
                              <li>
                                  <a href="bs-basic-table.html" class="waves-effect waves-dark">
                                      ...
                                      <span class="pcoded-mtext" data-i18n="nav.form-components.main">Data Pesanan Anda</span>
                                      <span class="pcoded-mcaret"></span>
                                  </a>
                              </li>
