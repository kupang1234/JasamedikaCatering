            ...
            <div class="pcoded-wrapper">
                <nav class="pcoded-navbar">
                        ...
                        <ul class="pcoded-item pcoded-left-item">
                          <li >
                              <a href="/customer/dashboard" class="waves-effect waves-dark ">
                            ...
                            <li class="active">
                                <a href="{{ route('customer.cp') }}" class="waves-effect waves-dark">
                                                    ...
                                                    <table class="table">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th style="text-align: center;">Alamat Catering</th>
                                                                <th style="text-align: center;">Telepon Catering</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align: center;">{{ $merchant->nama_perusahaan }}</td>
                                                                <td style="white-space: normal;">{{ $merchant->alamat}}</td>
                                                                <td style="text-align: center;">{{ $merchant->telepon}}</td>
                                                                <td style="white-space: normal">{{ $merchant->deskripsi}}</td>
                                                                <td style="text-align: center;">
                                                                    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#editMenuModal">Lihat Menu</button>
