                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#menuModal">Tambah Menu</button>
                                                <br>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <th scope="row">1</th>
                                                                <td><img src="{{ Storage::url($menu->foto)}}" width="100" alt="{{ $menu->nama_menu}}"></td>
                                                                <td>{{ $menu->nama_menu}}</td>
                                                                <td style="white-space: normal">{{ $menu->deskripsi}}</td>
                                                                <td>{{ $menu->harga}}</td>
                                                                <td>
                                                                    <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#editMenuModal">Edit</button>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('menu.update', $menu) }}" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            @endif
                                                            <div class="form-group">
                                                                <label for="name">Gambar Menu:</label>
                                                                <input type="file" name="foto" id="foto" class="form-control" value="{{ $menu->foto }}" >
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="deskripsi">Deskripsi:</label>
                                                                <input type="text" name="deskripsi" id="deskripsi" class="form-control" value="{{ $menu->deskripsi }}" required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="harga">Harga:</label>
                                                                <input type="text" name="harga" id="harga" class="form-control" value="{{ $menu->harga }}" required>
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('menu.store') }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    <label for="foto">Gambar Menu:</label>
